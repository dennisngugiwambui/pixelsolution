...
namespace PixelSolution.Migrations
{
    ...
    [Migration("20251002172444_AddQRCodePaymentAndManualMpesaEntryTables")]
    partial class AddQRCodePaymentAndManualMpesaEntryTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PixelSolution.Models.ManualMpesaEntry", b =>
                {
                    b.Property<int>("ManualMpesaEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ManualMpesaEntryId"));
                    ...
                    b.Property<string>("MpesaMessage")
                        .IsRequired()
                    ...
                    b.HasKey("ManualMpesaEntryId");

                    b.HasIndex("EnteredByUserId");

                    b.HasIndex("SaleId");

                    b.ToTable("ManualMpesaEntries");
                });
            ...
            modelBuilder.Entity("PixelSolution.Models.PendingMpesaTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PendingMpesaTransactions");
                });
            ...
            modelBuilder.Entity("PixelSolution.Models.QRCodePayment", b =>
                {
                    b.Property<int>("QRCodePaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("QRCodePaymentId"));
                    ...
                    b.HasKey("QRCodePaymentId");

                    b.HasIndex("CreatedByUserId");

                    b.HasIndex("SaleId");

                    b.ToTable("QRCodePayments");
                });
            ...
            modelBuilder.Entity("PixelSolution.Models.UnusedMpesaTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UnusedMpesaTransactions");
                });
            ...
            modelBuilder.Entity("PixelSolution.Models.ManualMpesaEntry", b =>
                {
                    b.HasOne("PixelSolution.Models.User", "EnteredByUser")
                        .WithMany()
